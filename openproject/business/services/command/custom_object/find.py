...
from openproject.business.services.command.custom_object.custom_object_command import CustomObjectCommand
from openproject.model.custom_object import CustomObject
